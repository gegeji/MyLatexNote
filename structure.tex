...
% \newenvironment{word}[1]{\begin{vocabulary}[#1] \index{#1}}{ \end{vocabulary}}

\usepackage{xparse}
\NewDocumentEnvironment{wordRef}{ m o}{
	% Start Code
	\IfNoValueTF{#2}{
		...
		\begin{vocabulary}[#1]
			...
			\hyperref[#1]{See \textbf{#1} (Vocabulary \ref{#1})}.
		}{
		\begin{vocabulary}[#1]
			\index{#2}
			\hyperref[#2]{See \textbf{#2} (Vocabulary \ref{#2})}.
			
	}
}{	% End Code
		\end{vocabulary}
}
\NewDocumentEnvironment{word}{mo}{
	% Start Code
	\IfNoValueTF{#2}{
		\begin{vocabulary}[#1]
			\label{#1}
...
\node[draw=ocre!60,line width=1pt,circle,fill=ocre!25,font=\sffamily\bfseries,inner sep=2pt,outer sep=0pt] at (-15pt,0pt){\textcolor{ocre}{!}};\end{tikzpicture}} % Orange ! in a circle

% \makebox[-2.5pt]{
%	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
%		%uncomment if require: \path (0,300); %set diagram left start at 0, and has height of 300

%		%Flowchart: Connector [id:dp5263589531164479] 
%		\draw  [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ][line width=2.25]  (97.64,137.43) .. controls (97.64,131.86) and (102.29,127.34) .. (108.04,127.34) .. controls (113.79,127.34) and (118.45,131.86) .. (118.45,137.43) .. controls (118.45,143) and (113.79,147.51) .. (108.04,147.51) .. controls (102.29,147.51) and (97.64,143) .. (97.64,137.43) -- cycle ;
%		%Shape: Star [id:dp8903341744926845] 
%		\draw  [fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=1 ] (108.04,129.72) -- (110.48,134.31) -- (115.93,135.04) -- (111.99,138.62) -- (112.92,143.66) -- (108.04,141.28) -- (103.16,143.66) -- (104.1,138.62) -- (100.15,135.04) -- (105.6,134.31) -- cycle ;
