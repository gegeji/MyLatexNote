...
\definecolor{lightViolet}{RGB}{234, 229, 255}
...
\newenvironment{remark}{\begin{rBox}\par\vspace{0.125pt}\small % Vertical white space above the remark and smaller font size
\begin{list}{}{
...
\node[draw=coral!60,line width=1pt,circle,fill=coral!25,font=\sffamily\bfseries,inner sep=2pt,outer sep=0pt] at (-15pt,-5pt){\textcolor{coral}{!}};\end{tikzpicture}

\advance\baselineskip -0.5pt}{\end{list}\vskip0.125pt\end{rBox}} % Tighter line spacing and white space after remark
