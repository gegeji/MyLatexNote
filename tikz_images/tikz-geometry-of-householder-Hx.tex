...
\draw [shift={(371.96,79.38)}, rotate = 103.17] [fill={rgb, 255:red, 252; green, 132; blue, 147 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (14.29,-6.86) -- (0,0) -- (14.29,6.86) -- cycle    ;
...
\draw [shift={(371.96,79.38)}, rotate = 141.34] [fill={rgb, 255:red, 152; green, 195; blue, 245 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (14.29,-6.86) -- (0,0) -- (14.29,6.86) -- cycle    ;

% Text Node
\draw (302.81,99.57) node [anchor=north west][inner sep=0.75pt]  [xscale=0.75,yscale=0.75]  {$w$};
% Text Node
\draw (175,208.4) node [anchor=north west][inner sep=0.75pt]  [xscale=0.75,yscale=0.75]  {$-\operatorname{sign}( y_{1}) \| y\| e_{1}$};
% Text Node
\draw (360.24,141.91) node [anchor=north west][inner sep=0.75pt]  [rotate=-357.61,xscale=0.75,yscale=0.75]  {$y$};
% Text Node
\draw (447,176) node [anchor=north west][inner sep=0.75pt]  [xscale=0.75,yscale=0.75] [align=left] {坐标轴 $\displaystyle e_{1}$};
% Text Node
\draw (394,237) node [anchor=north west][inner sep=0.75pt]  [xscale=0.75,yscale=0.75] [align=left] {超平面$\displaystyle \left\{x|w^{T} x=0\right\}$};
