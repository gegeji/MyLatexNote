...
\begin{equation} \sigma_{z}=1.4826 \mathrm{median}_{\mathrm{t}}\left(\left\|z_{t}-x_{t, i}\right\|_{\text {great circle }}\right) \end{equation}
...
评价指标：reported error
  \begin{equation} \left(\mathrm{d}-+\mathrm{d}_{+}\right) / \mathrm{d}_{0} \end{equation} 
